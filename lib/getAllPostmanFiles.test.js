...
test('returns proper error for invalid directoryPath', async() => {
    const invalidPath = path.join(__dirname, '/unit-tests/test-data/test-project1', 'does-not-exist')
    const directoryList = [
        invalidPath
    ]
...
test('returns proper error for directoryPath with no postman tests', async() => {
    const invalidPath = path.join(__dirname, '/unit-tests/test-data/test-project1', 'xrun')
    const directoryList = [
        invalidPath
    ]
