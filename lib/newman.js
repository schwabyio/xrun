...
const newman = function newman() {
    ...
    //
    ////////////////////////////////////////////////////////////////////////////
    self.run = async function run(settings, postmanCollection) {
        const newmanOptions = self.constructPostmanOptions(settings, postmanCollection)
    ...
    //
    ////////////////////////////////////////////////////////////////////////////
    self.constructPostmanOptions = function constructPostmanOptions(settings, postmanCollection) {
        const options = {}
