...
const xRunCLI = function xRunCLI() {
    ...
    self.getUsage = function getUsage() {
        ...
        "   USAGE: " + appCLIName + " <program-command> [--settingsKey settingsValue]" + EOL +
        "" + EOL +
        "" + EOL +
        "              <program-command> - Required. Valid program-command values are:" + EOL +
        "" + EOL +
        "                                          g[et]  - GET a list of all Postman collections from the project." + EOL +
        "" + EOL +
        "                                                   NOTE: collections from xrun/exclude-list.json ARE NOT included." + EOL +
        "" + EOL +
        "                                          a[ll]  - Run ALL Postman collections from the project." + EOL +
        "" + EOL +
        "                                                   NOTE: collections from xrun/exclude-list.json ARE NOT included." + EOL +
        "" + EOL +
        "                 <collectionAndOrDirectoryList>  - Run one or more specific Postman collections from the project by" + EOL +
        "                                                   providing a comma seperated list of COLLECTION NAMEs and/or DIRECTORY NAMEs." + EOL +
        "" + EOL +
        "                                                   NOTE: collections from xrun/exclude-list.json ARE included." + EOL +
        "" + EOL +
        "    --settingsKey settingsValue - Optional. Any number of settings overrides." + EOL +
        "" + EOL +
